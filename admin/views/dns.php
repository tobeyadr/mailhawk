...
<div class="mailhawk-connect setup">
    ...
    <p>Before you can start sending email, you must configure your DNS records for the emails you just registered.</p>
	...
	<?php foreach ( $domains as $domain ): ?>
        ...
        <input class="code" onfocus="this.select()" type="text" value="<?php esc_attr_e( $domain['dns']['dkim_value'] ); ?>"
               readonly>
        ...
        <input class="code" onfocus="this.select()" type="text" value="<?php esc_attr_e( $domain['dns']['rp_value'] ); ?>"
               readonly>
