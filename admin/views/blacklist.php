...
<div class="mailhawk-content-box">
    ...
    <form method="post">
        ...
        <input class="button button-secondary" type="submit" value="<?php esc_attr_e( "Add" ); ?> ">
    </form>
...
<div class="mailhawk-content-box">
    ...
    <p class="description"><?php _e( 'You can whitelist an email address to prevent it from being added to the blacklist. If it is already on the blacklist it will be removed. You can enter <code>*@domain.com</code> to whitelist all email addresses belonging to <code>domain.com</code>', 'mailhawk' ); ?></p>
</div>
