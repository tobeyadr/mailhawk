...
* FIXED Overview number formatting.
...
= 1.2.2 (2023-10-23) =
* ADDED Return-Path DNS record setup instruction.

= 1.2.1 (2023-05-19) =
* ADDED Which account the MailHawk plugin is currently connected to in the Danger Zone settings.
