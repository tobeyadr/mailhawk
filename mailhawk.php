 ...
 * @todo setting to automatically blacklist bounced emails.
 * @todo set email log status to bounced when webhook received.
 */
...
if ( ! version_compare( PHP_VERSION, '5.6', '>=' ) ) {
    ...
    require MAILHAWK_PATH . 'includes/plugin.php';
}
